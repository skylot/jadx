...
public class MainWindow extends JFrame {
    ...
    private void toggleDeobfuscation() {
        ...
        if (deobfOn) {
            Deobfuscator.RenameClassWithSourceName = false;

            int ret = JOptionPane.showOptionDialog(null, NLS.str("dialog.useSourceNameRenameClass_message"), NLS.str("dialog.useSourceNameRenameClass_title"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
            switch (ret) {
                case 0:
                    Deobfuscator.RenameClassWithSourceName = true;
                    break;
                case 1:
                    break;
                default:
